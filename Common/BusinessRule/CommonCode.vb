...
#Region " Custom "
        ...
        Public Function SelectStandardFieldByKdField(ByVal strKdField As String) As DataTable
            Dim cmdToExecute As SqlCommand = New SqlCommand
            cmdToExecute.CommandText = "spLinkGetStandardFieldByKdField"
            cmdToExecute.CommandType = CommandType.StoredProcedure

            Dim toReturn As DataTable = New DataTable("spLinkGetStandardFieldByKdField")
            Dim adapter As SqlDataAdapter = New SqlDataAdapter(cmdToExecute)

            cmdToExecute.Connection = _mainConnection

            Try
                cmdToExecute.Parameters.AddWithValue("@kdfield", strKdField)
