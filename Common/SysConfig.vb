...
Namespace QIS.Common
    ...
    Public Class SysConfig
        ...
        Private Const WEB_ENABLEPAGECACHE As String = "QIS.Web.EnablePageCache"
        Private Const WEB_PAGECACHEEXPIRESINSECONDS As String = "QIS.Web.PageCacheExpiresInSeconds"
        Private Const WEB_ENABLESSL As String = "QIS.Web.EnableSsl"
        Private Const DATAACCESS_CONNECTIONSTRING As String = "QIS.DataAccess.ConnectionString"
        Private Const DATAACCESS_CONFIGURATION_CONNECTIONSTRING As String = "QIS.DataAccess.ConnectionString"
        Private Const APP_ID As String = "QIS.Web.AppId"
        Private Const REPORTS_FOLDER As String = "QIS.Web.ReportsFolder"
        Private Const CUSTOM_REPORTS_FOLDER As String = "QIS.Web.CustomReportsFolder"
        Private Const PHYSICAL_REPORTS_FOLDER As String = "QIS.Web.PhysicalReportsFolder"
        Private Const APPLICATION_URL As String = "QIS.Web.ApplicationURL"
        Private Const APPLICATION_URL_DEFAULT As String = ""

        Private Const MODULE_APPL As String = "QIS.Web.ModuleAppl"
        Private Const MODULE_APPLCL As String = "QIS.Web.ModuleApplCl"
