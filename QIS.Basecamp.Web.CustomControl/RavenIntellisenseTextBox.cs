...
namespace QIS.Basecamp.Web.CustomControl
{
    public class QISIntellisenseTextBox : WebControl
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            imgSearch.Src = "/qistoollib/Images/QuickSearchIcon.png";
            ...
            imgUp.Src = "/qistoollib/Images/up-arrow.png";
            ...
            imgDown.Src = "/qistoollib/Images/down-arrow.png";
        ...
        private void RegisterJavaScript()
        {
            ...
            script.Controls.Add(new LiteralControl(string.Format("window.{0}Helper = new QISClientIntellisenseTextBoxHelper();", this.ClientID)));
