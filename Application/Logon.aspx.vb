...
Namespace QIS.Web
    ...
    Public Class Logon
        ...
        Protected WithEvents lblLinkParamedicID As Label
...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Else
                ...
                lblLinkParamedicID.Text = String.Empty
            End If
        End Sub
            ...
            If dtUser.Rows.Count = 1 Then
                If CType(dtUser.Rows(0)("Password"), String).Trim = FormsAuthentication.HashPasswordForStoringInConfigFile(txtPassword.Text.Trim, "sha1") Then
                    ...
                    If ddlUserProfile.Items.Count = 1 Then
                        ...
                        oProfile.Dispose()
                        oProfile = Nothing
                        Dim _strLinkParamedicID As String = CType(dtUser.Rows(0)("LinkParamedicID"), String).Trim

                        MyBase.LoggedOnProfileID = _strProfileID
                        MyBase.LoggedOnProfileName = _strProfileName
                        MyBase.LoggedOnLinkParamedicID = _strLinkParamedicID

                        FormsAuthentication.RedirectFromLoginPage("*", False)                        
                    Else
                        pnlLogin.Visible = False
                        pnlChooseProfileAndSite.Visible = True
                        lblLinkParamedicID.Text = CType(dtUser.Rows(0)("LinkParamedicID"), String).Trim
                    End If                                                    
                Else
        ...
        Private Sub btnContinue_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnContinue.Click
            ...
            If Len(_strProfileID.Trim) > 0 Then
                ...
                oProfile.Dispose()
                oProfile = Nothing
                Dim _strLinkParamedicID As String = lblLinkParamedicID.Text.Trim
