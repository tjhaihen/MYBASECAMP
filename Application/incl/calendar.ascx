<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="calendar.ascx.vb" Inherits="QIS.Web.Calendar"
    TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<asp:TextBox ID="txtPopUpCal" runat="server" MaxLength="11" AutoPostBack="False"
    CssClass="center" Width="100"></asp:TextBox>
<img id="calIcon" alt="Click here to select a date" src="/qistoollib/images/datepicker_popup.gif"
