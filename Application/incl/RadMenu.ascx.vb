...
#Region "  Private Functions  "
        Private Sub CreateMenu()
            ...
            Menu.AppID = App.App_Basecamp.Trim
        End Sub
        ...
        Private Sub initHomeButton()
            Dim isEMR As Boolean = False
            If Common.Methods.GetCommonCode("SYSEMR", "SYSTEM").Trim = "1" Then
                isEMR = True
            Else
                isEMR = False
            End If
            pnlHomeBAS.Visible = Not isEMR
            pnlHomeEMR.Visible = isEMR
        End Sub
#End Region
