...
Namespace QIS.BussinessRules
    Public Enum QISBRErr
        AllOk
        ' // Add more here (check the comma's!)
    End Enum

    Public Enum QISRecStatus
        CurrentRecord = 0
        NextRecord = 1
        PreviousRecord = 2
    End Enum
    ...
    Public Interface ICommonDBAccess
        ...
        Function SelectOne(Optional ByVal recStatus As QISRecStatus = QISRecStatus.CurrentRecord) As DataTable
...
#End Region
        ...
        Private Sub InitClass()
            ...
            _errorCode = New SqlInt32(QISBRErr.AllOk)
            _isDisposed = False
            ' // default connectionstring, from configuration file..!!
            Me.ConnectionString = SysConfig.ConnectionString
        End Sub
        ...
        Public Overridable Function SelectOne(Optional ByVal recStatus As QISRecStatus = QISRecStatus.CurrentRecord) As DataTable Implements ICommonDBAccess.SelectOne
            Throw New NotImplementedException()
        End Function
