...
Namespace QIS.Web
    ...
    Public Class PageBase
        ...
        Private _strLinkParamedicID As String
        Private _bolIsPhysician As String
        ...
        Public Property PB_CacheLoggedOnUser() As DataSet
            Get
                Try
                    ...
                    dttable.Columns.Add("Salutation")
                    dttable.Columns.Add("AcademicTitle")
            ...
            Set(ByVal Value As DataSet)
                ...
                Else
                    ...
                    str += CType(Value.Tables("User").Rows(0)("Salutation"), String) + "|"
                    str += CType(Value.Tables("User").Rows(0)("AcademicTitle"), String)
        ...
        Public ReadOnly Property LoggedOnUserName() As String
            Get
                ...
                Else
                    moduleTable = moduleSet.Tables("User")
                    If (moduleTable.Rows.Count = 1) Then
                        UID = CType(moduleTable.Rows(0)("userName"), String)
                    End If
                End If
        ...
        Public Property LoggedOnLinkParamedicID() As String
            Get
                Try
                    Dim str As String = Request.Cookies(commonFunction.Key_CacheLoggedOnLinkParamedicID).Value
                    Return str.Trim
                Catch
                    Return Nothing
                End Try
            ...
            Set(value As String)
                If value Is Nothing Then
                    Dim myCookie As HttpCookie
                    myCookie = New HttpCookie(commonFunction.Key_CacheLoggedOnLinkParamedicID)
                    myCookie.Expires = DateTime.Now.AddDays(-1D)
                    Response.Cookies.Add(myCookie)
                Else
                    _strLinkParamedicID = value
                    Dim cookie As HttpCookie
                    cookie = New HttpCookie(commonFunction.Key_CacheLoggedOnLinkParamedicID)
                    cookie.Value = _strLinkParamedicID
                    Response.SetCookie(cookie)
                End If
            End Set
        End Property
        ...
        Public ReadOnly Property PB_UserFullName() As String
            Get
                ...
                Dim _strSalutation, _strAcademicTitle As String
                ...
                _strSalutation = CType(PB_CacheLoggedOnUser.Tables("User").Rows(0)("Salutation"), String)
                _strAcademicTitle = CType(PB_CacheLoggedOnUser.Tables("User").Rows(0)("AcademicTitle"), String)
                ...
                _strFullName = _strFirstName.Trim + " " + _strMiddleName.Trim + " " + _strLastName.Trim
                If _strSalutation.Length > 0 Then _strFullName = _strSalutation.Trim + " " + _strFullName.Trim
                If _strAcademicTitle.Length > 0 Then _strFullName += ", " + _strAcademicTitle.Trim
