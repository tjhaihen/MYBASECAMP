    ...
    Public Class ModuleBase
        ...
        Public ReadOnly Property MB_UserFullName() As String
            Get
                ...
                _strSalutation = CType(MB_CacheLoggedOnUser.Tables("User").Rows(0)("Salutation"), String)
                _strAcademicTitle = CType(MB_CacheLoggedOnUser.Tables("User").Rows(0)("AcademicTitle"), String)
