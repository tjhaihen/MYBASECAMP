<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ErrMsg.aspx.vb" Inherits="QIS.Web.ErrMsg" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>Basecamp - Error Handler Page</title>
    ...
    <table cellspacing="0" cellpadding="5" border="0">
        ...
        <tr>
            <td valign="absmiddle" style="padding: 20px 0 0 60px;">
                ...
                <img src="/qistoollib/images/email.png" border="0" alt="" align="absmiddle" />&nbsp;
                support@medinfras.com&nbsp;&nbsp;
                <img src="/qistoollib/images/phone.png" border="0" alt="" align="absmiddle" />&nbsp;
                +62 878 8214 7959
            </td>
        </tr>
        <tr>
