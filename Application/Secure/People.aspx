...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="People.aspx.vb" Inherits="QIS.Web.Secure.User" %>
                                        ...
                                        <td valign="top">
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <asp:Panel ID="pnlEMR" runat="server">
                                                            <table width="100%">
                                                                <tr>
                                                                    <td style="width: 150px;" class="right">
                                                                        Link Paramedic ID
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtLinkParamedicID" runat="server" Width="300"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="right">
                                                                    ...
                                                                    <td>
                                                                        <asp:CheckBox ID="chkIsPhysician" runat="server" Text="Is Physician" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </asp:Panel>
                                        ...
                                        <td style="width: 100%;">
                                            <table width="100%" cellspacing="1">
                                                <tr>
                                                    ...
                                                    <td valign="top" class="center">
                                                        <asp:Button ID="btnUserProjectAdd" runat="server" Text="Add >" CssClass="sbttn" Width="100px" /><br />
                                                        <asp:Button ID="btnUserProjectAddAll" runat="server" Text="Add All >>" CssClass="sbttn"
                                                            Width="100px" /><br />
                                                        <br />
                                                        <asp:Button ID="btnUserProjectRemoveAll" runat="server" Text="<< Remove All" CssClass="sbttn"
                                                            Width="100px" /><br />
                                                        <asp:Button ID="btnUserProjectRemove" runat="server" Text="< Remove" CssClass="sbttn"
                                                            Width="100px" />
                                                    </td>
                                                    <td valign="top" style="width: 40%;">
                                                        <asp:DataGrid ID="grdProjectUser" runat="server" BorderWidth="0" GridLines="None"
                                                            Width="100%" CellPadding="2" CellSpacing="1" ShowHeader="true" ShowFooter="false"
                                                            AutoGenerateColumns="false">
                                                            <HeaderStyle HorizontalAlign="Left" CssClass="gridHeaderStyle" />
                                                            <ItemStyle CssClass="gridItemStyle" />
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateColumn runat="server" HeaderText="Project Name">
                                                                    <ItemTemplate>
                                                                        <asp:Label runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "projectUserID") %>'
                                                                            ID="_lblProjectUserID" Visible="false" />
                                                                        <%# DataBinder.Eval(Container.DataItem, "ProjectName") %>
                                                                    </ItemTemplate>
                                                                </asp:TemplateColumn>
                                                            </Columns>
