<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReportImage.aspx.vb" Inherits="QIS.Web.Secure.ReportImage" %>
                                                                    ...
                                                                    <table width="100%" cellspacing="0" cellpadding="2">
                                                                        <tr>
                                                                            ...
                                                                            <td align="right" class="gridAlternatingItemStyle">
                                                                                <asp:ImageButton ID="_ibtnpicEdit" runat="server" CommandName="Edit" ImageUrl="/qistoollib/images/edit_small.png"
                                                                                    ImageAlign="AbsMiddle" ToolTip="Edit" />
                                                                                <asp:ImageButton ID="_ibtnpicDelete" runat="server" CommandName="Delete" ImageUrl="/qistoollib/images/delete_small.png"
