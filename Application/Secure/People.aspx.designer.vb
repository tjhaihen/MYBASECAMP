...
Namespace QIS.Web.Secure
    ...
    Partial Public Class User
        ...
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents pnlEMR As Global.System.Web.UI.WebControls.Panel
        ...
        '''<summary>
        '''btnUserProjectAdd control.
        '''</summary>
        '''<remarks>
        '''Auto-generated field.
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents btnUserProjectAdd As Global.System.Web.UI.WebControls.Button

        '''<summary>
        '''btnUserProjectAddAll control.
        '''</summary>
        '''<remarks>
        '''Auto-generated field.
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents btnUserProjectAddAll As Global.System.Web.UI.WebControls.Button

        '''<summary>
        '''btnUserProjectRemoveAll control.
        '''</summary>
        '''<remarks>
        '''Auto-generated field.
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents btnUserProjectRemoveAll As Global.System.Web.UI.WebControls.Button

        '''<summary>
        '''btnUserProjectRemove control.
        '''</summary>
        '''<remarks>
        '''Auto-generated field.
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents btnUserProjectRemove As Global.System.Web.UI.WebControls.Button

        '''<summary>
        '''grdProjectUser control.
        '''</summary>
        '''<remarks>
        '''Auto-generated field.
        '''To modify move field declaration from designer file to code-behind file.
        '''</remarks>
        Protected WithEvents grdProjectUser As Global.System.Web.UI.WebControls.DataGrid
