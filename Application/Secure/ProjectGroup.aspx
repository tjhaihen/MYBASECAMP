...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ProjectGroup.aspx.vb" Inherits="QIS.Web.Secure.ProjectGroup" %>
                        ...
                        <tr>
                            <td align="left">
                                <table cellspacing="0" cellpadding="5" width="100%">
                                            ...
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 500px;">
                                                        <asp:TextBox ID="txtProjectGroupID" Width="300" runat="server" AutoPostBack="True" Visible="false" />
                                                        <asp:TextBox ID="txtProjectGroupName" Width="300" MaxLength="15" runat="server" AutoPostBack="True" />
                                                        <asp:RequiredFieldValidator ID="rfvProjectGroupName" runat="server" ControlToValidate="txtProjectGroupName"
                                                            ErrorMessage="Project Group Name" Display="dynamic" Text="*">
                                    ...
                                    <tr class="rbody">
                                        <td valign="top">
                                            <asp:DataGrid ID="grdProjectGroup" runat="server" BorderWidth="0" GridLines="None" Width="100%"
                                                ...
                                                <columns>
                                                    ...
                                                    <asp:TemplateColumn runat="server" HeaderText="Project Group Name">
                                                        <ItemTemplate>
                                                            <asp:Label runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ProjectGroupID") %>'
                                                                ID="_lblProjectGroupID" Visible="false" />
                                                            <asp:Label runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ProjectGroupName") %>'
                                                                ID="_lblProjectGroupName" />
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
