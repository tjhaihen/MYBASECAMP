...
<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Logon.aspx.vb" Inherits="QIS.Web.Logon"
                ...
                <table width="50%">
                    <tr>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="txttitle" valign="top" colspan="2" style="padding: 0 0 20px 0;">
                                            <img src="/qistoollib/images/Basecamp_logo_small.png" alt="" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="txterrmsg">
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td class="txtusername" style="padding-top: 20px;">
                                            ...
                                            <asp:Label ID="lblLinkParamedicID" runat="server" Visible="false"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <tr>
                                    <td style="padding-top: 2px;">
                                        <table cellpadding="1" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <img src="/qistoollib/images/clientCompanyLogo.png" width="70" alt="" />
                                                </td>
                                                <td valign="top" style="padding-left: 5px;">
                                                    <table cellpadding="1" cellspacing="0" class="txtweak">
                                                        <tr>
                                                            <td>
                        ...
                        <td style="width: 50%; padding-top: 20px; padding-left: 50px;" valign="top">
                            <img src="/qistoollib/images/main.png" alt="Main" />
                        </td>
                    </tr>
                    <tr>
